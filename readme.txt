...
> **Nota:** Proyecto desarrollado para la tienda PerfecTime, especialista en venta de bisutería y relojes.

## PerfecTime API

Esta API fue diseñada para manejar la base de datos de la tienda y poder gestionarla desde cualquier dispositivo con acceso a internet, ya sea por medio de una app o web.
...
Esta aplicación fue desarrollada para la empresa PerfecTime, como proyecto de Base de Datos bajo la supervición del profesor Gilberto Huesca Juarez y programada por:

Jorge Arturo César Martínez:    A01334126
Daniel Osorio Rodriguez:        A01331173
Issac Arzate Soto:              A01214624



## Vulnerabilidades

Esta aplicación fue diseñada con altos estándares de seguridad, pero se dejó el acceso a cualquier dispositivo para evitar problemas de acceso por parte del cliente y del profesor a su momento de evaluación.
