                ...
                return d(i, [{
                    ...
                    value: function(b) {
                        ...
                        if (!(b > this._items.length - 1 || 0 > b)) {
                            if (this._isSliding)
                                return void a(this._element).one(o.SLID, function() {
                                return c.to(b)
                            });
                            if (d === b)
                ...
                return d(i, [{
                    ...
                    value: function(b) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            ...
                            }), f && e.reflow(this._backdrop), a(this._backdrop).addClass(p.IN), !b)
                                return;
                            if (!f)
                                return void b();
                ...
                return d(i, [{
                    ...
                    value: function() {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            if (e.supportsTransitionEnd() && a(this.tip).hasClass(q.FADE))
                                return void a(this.tip).one(e.TRANSITION_END, l).emulateTransitionEnd(i._TRANSITION_DURATION);
                            l()
                        }
                    }
                }, {
